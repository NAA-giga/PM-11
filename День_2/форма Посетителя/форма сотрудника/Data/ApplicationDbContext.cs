...
namespace форма_сотрудника.Data
{
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Employee>().Property(e => e.PassportSeries).HasColumnName("Серия_паспорта");
            modelBuilder.Entity<Employee>().Property(e => e.PassportNumber).HasColumnName("Номер_паспорта");
            modelBuilder.Entity<Employee>().Property(e => e.PhotoPath).HasColumnName("Фото_Посетителя");
            modelBuilder.Entity<Employee>().Property(e => e.PassportScanPath).HasColumnName("скан_паспорта_посетителя");
            ...
            modelBuilder.Entity<Посетитель>().Property(v => v.PhotoPath).HasColumnName("Фото_Посетителя");
            modelBuilder.Entity<Посетитель>().Property(v => v.PassportScanPath).HasColumnName("скан_паспорта_посетителя");
            modelBuilder.Entity<Посетитель>().Property(v => v.Organization).HasColumnName("Организация");
            modelBuilder.Entity<Посетитель>().Property(v => v.EmployeeId).HasColumnName("Сотрудник_id");
            modelBuilder.Entity<Посетитель>().Property(v => v.DepartmentId).HasColumnName("Подразделение_id");
            modelBuilder.Entity<Посетитель>().Property(v => v.Password).HasColumnName("Пароль");
            modelBuilder.Entity<Посетитель>().Property(v => v.Login).HasColumnName("Логин");
